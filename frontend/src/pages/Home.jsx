...
const Home = () => {
  return (
    <div className="min-h-screen text-glass-main overflow-x-hidden">
      <header className="fixed top-2 sm:top-3 left-0 right-0 z-50 px-2.5 sm:px-6">
        <div className="max-w-7xl mx-auto h-14 sm:h-20 flex items-center justify-between glass-surface rounded-xl sm:rounded-3xl px-2.5 sm:px-6 border border-white/70">
          <div className="flex items-center gap-2 sm:gap-3 min-w-0">
            <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl sm:rounded-2xl flex items-center justify-center text-white bg-gradient-to-br from-blue-500 to-indigo-600 shadow-lg shadow-blue-600/30">
              <span className="material-symbols-outlined text-2xl">movie_edit</span>
            </div>
            <span className="text-sm min-[380px]:text-base sm:text-xl font-extrabold tracking-tight text-blue-900 truncate max-[359px]:hidden">Cineshadow <span className="font-medium text-blue-600">Languages</span></span>
          </div>
          ...
          <div className="flex items-center gap-2 shrink-0">
            <Link to="/login" className="glass-btn glass-btn-primary px-3 min-[380px]:px-4 sm:px-6 py-2 sm:py-2.5 rounded-full text-xs min-[380px]:text-sm font-bold flex items-center gap-1.5 sm:gap-2">
              <LogIn className="w-4 h-4 max-[380px]:hidden" />
              Đăng nhập
            </Link>
          </div>
        </div>
      ...
      <main className="pt-20 sm:pt-28 pb-10">
        <section className="relative overflow-hidden py-10 sm:py-20 lg:py-28">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            <div className="relative z-10 space-y-5 sm:space-y-7 animate-glass-rise">
              ...
              <h1 className="text-3xl min-[420px]:text-4xl sm:text-5xl lg:text-7xl font-black text-blue-950 leading-[1.05] tracking-tight">
                Học ngoại ngữ <span className="italic text-blue-600">"chuẩn đét"</span> cùng phim ảnh
              </h1>
              <p className="text-sm min-[420px]:text-base sm:text-xl text-glass-subtle max-w-xl leading-relaxed">
            ...
            <div className="relative animate-glass-rise" style={{ animationDelay: '0.08s' }}>
              ...
              <div className="relative rounded-[24px] sm:rounded-[30px] overflow-hidden glass-surface-strong border border-white/70 p-2.5 sm:p-4">
                ...
                <div className="absolute bottom-4 sm:bottom-7 left-4 sm:left-7 right-4 sm:right-7 p-3 sm:p-4 glass-surface rounded-2xl flex items-center gap-3 sm:gap-4 border border-white/75">
                  ...
                  <div>
                    ...
                    <p className="text-xs min-[420px]:text-sm font-bold text-blue-900">Đi đến nơi có gió - Episode 04</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section id="shadowing-info" className="py-10 sm:py-16 max-w-7xl mx-auto px-4 sm:px-6 scroll-mt-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 stagger-sequence">
            <div className="stagger-item glass-surface rounded-3xl p-6 sm:p-8 border border-white/70 flex flex-col items-center text-center space-y-5 sm:space-y-6 glass-hover-lift">
              <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl sm:rounded-3xl bg-gradient-to-br from-blue-400 to-cyan-400 flex items-center justify-center shadow-lg shadow-blue-300/40">
                <span className="material-symbols-outlined text-4xl text-white">headset</span>
              </div>
              <h3 className="text-xl sm:text-2xl font-bold text-blue-950">1. Nghe kỹ</h3>
              <p className="text-glass-subtle">Nghe đoạn hội thoại trong phim để nắm bắt ngữ điệu và cảm xúc của nhân vật.</p>
            </div>
            <div className="stagger-item glass-surface rounded-3xl p-6 sm:p-8 border border-white/70 flex flex-col items-center text-center space-y-5 sm:space-y-6 glass-hover-lift">
              <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl sm:rounded-3xl bg-gradient-to-br from-fuchsia-400 to-violet-400 flex items-center justify-center shadow-lg shadow-fuchsia-300/40">
                <span className="material-symbols-outlined text-4xl text-white">record_voice_over</span>
              </div>
              <h3 className="text-xl sm:text-2xl font-bold text-blue-950">2. Bắt chước</h3>
              <p className="text-glass-subtle">Đuổi theo lời thoại ngay lập tức với tốc độ và ngữ khí y hệt bản gốc.</p>
            </div>
            <div className="stagger-item glass-surface rounded-3xl p-6 sm:p-8 border border-white/70 flex flex-col items-center text-center space-y-5 sm:space-y-6 glass-hover-lift">
              <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl sm:rounded-3xl bg-gradient-to-br from-emerald-400 to-teal-500 flex items-center justify-center shadow-lg shadow-emerald-300/40">
                <span className="material-symbols-outlined text-4xl text-white">mic</span>
              </div>
              <h3 className="text-xl sm:text-2xl font-bold text-blue-950">3. Ghi âm</h3>
        ...
        <section className="py-12 sm:py-24 max-w-7xl mx-auto px-4 sm:px-6">
          <div className="relative glass-surface-strong rounded-[32px] p-6 sm:p-12 lg:p-20 overflow-hidden text-center space-y-6 sm:space-y-8 border border-white/70">
            ...
            <h2 className="text-2xl min-[420px]:text-3xl sm:text-4xl lg:text-5xl font-black text-blue-950 relative z-10">
              Gia nhập cộng đồng học ngoại ngữ mỗi ngày
            </h2>
            <p className="text-base sm:text-xl text-glass-subtle max-w-2xl mx-auto relative z-10">
