...
INSERT IGNORE INTO `users` (`username`, `email`, `password_hash`, `full_name`, `role`, `hsk_level`, `is_active`, `email_verified`)
VALUES ('admin', 'admin@cineshadow.com', '$2a$10$MoECB3fY75ls1XvSkYzr3ukGvTBrQz.cYkxsUjZGtfWU1nawhDNHy', 'Administrator', 'admin', 1, 1, 1);
